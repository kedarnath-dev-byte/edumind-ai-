...
===============================================================
# 🧠 EduMind AI — Project Context
⚠️ DO NOT EDIT MANUALLY — Auto-updated by Claude at end of every session. Upload this file at the start of every new chat to instantly resume work. DO NOT push this file to GitHub — keep it private on your laptop + Google Drive.


## 📅 Session Metadata
Last Updated: 2026-05-02
Current Chat Session: #2 — COMPLETED
Total Time Spent: ~4 hours
Active Skills: expert-dev-guide, edumind-context-continuity


## 👤 Project Owner
Name: Mamani Kedarnath
GitHub: kedarnath-dev-byte
Repo URL: https://github.com/kedarnath-dev-byte/edumind-ai-
Goal: Crack ₹2 Crore AI Engineer job
Domain: Education (EdTech)
Timeline: 6–8 weeks part-time
Local Folder: F:\Downloads\AI Generalist\EduTech
...
✅ ALL 7 LangGraph patterns
✅ Complete LangChain ecosystem
✅ Web + Android + iOS + Desktop deployment
✅ Gmail OAuth login for students
✅ Admin dashboard (Kedarnath sees all student activity)
✅ Share APK via WhatsApp (no Play Store needed)
✅ ₹0 budget (all free tier)
...
### Architecture
- Pattern: Modular Monolith (microservices-ready)
- Backend: Python 3.11.9 with FastAPI
- Frontend Web: React + Vite + TailwindCSS
- Mobile: Flutter (single codebase → Android + iOS)
- Desktop: Electron (Windows .exe)
- Database: SQLite (dev) → PostgreSQL (prod)
...
- LLM Provider: Groq API (Llama-3, free tier)
- Embeddings: HuggingFace sentence-transformers
- Auth: Gmail OAuth (Google SSO — free)
- Backend Deploy: Render free tier
- Frontend Deploy: Vercel free tier
- CI/CD: GitHub Actions
- Total Cost: ₹0

### System Versions (Confirmed on Laptop)
- Python: 3.11.9 ✅ (USE THIS — not 3.14!)
- Git: 2.39.0 ✅
- Node: v20.19.1 ✅
- OS: Windows (PowerShell) ✅
- Virtual Env: venv (NOT .venv) ✅

### Key Version Fixes (Learned in Session 2)
- numpy==1.26.4 (not 2.x — langchain conflict)
- sqlalchemy==2.0.35 (not 2.0.36 — langchain-community conflict)
- langchain-core==0.3.17 (not 0.3.15 — langchain-community conflict)
- unstructured==0.16.19 (not 0.16.5 — doesn't exist)
...
| # | Feature | Status | Steps | Commits |
|---|---------|--------|-------|---------|
| 1 | Project Setup & Structure | ✅ COMPLETE | 8/8 | 3/3 |
| 2 | Backend Setup & Config | ✅ COMPLETE | 12/12 | 5/5 |
| 3 | Document Ingestion Engine | ⏳ Pending | 0/8 | 0/5 |
| 4 | All 16 RAG Pipelines | ⏳ Pending | 0/32 | 0/5 |
| 5 | LangGraph Multi-Agent (7 patterns) | ⏳ Pending | 0/14 | 0/5 |
| 6 | Fine-Tuning Pipeline (8 frameworks) | ⏳ Pending | 0/16 | 0/5 |
| 7 | Serving Engines (5 servers) | ⏳ Pending | 0/10 | 0/5 |
| 8 | React Frontend Dashboard | ⏳ Pending | 0/20 | 0/5 |
| 9 | Evaluation & Monitoring | ⏳ Pending | 0/8 | 0/5 |
| 10 | Deployment (Live URL) | ⏳ Pending | 0/10 | 0/5 |
| 11 | Flutter Mobile App | ⏳ Pending | 0/15 | 0/5 |
| 12 | Electron Desktop App | ⏳ Pending | 0/8 | 0/5 |
| 13 | README + Architecture Docs | ⏳ Pending | 0/5 | 0/3 |
...
### ✅ Last Completed Step
- Feature: 2 — Backend Setup & Config
- Step: 12 of 12
- Description: Server running, health check passing, all 4 tests passed
- Date: 2026-05-02

### ⏭️ NEXT STEP (START HERE)
- Feature: 3 — Document Ingestion Engine
- Step: 1 of 8
- Action: Create base document loader class


## 🗂️ FILES ON GITHUB RIGHT NOW
